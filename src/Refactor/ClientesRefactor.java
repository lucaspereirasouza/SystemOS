...
public class ClientesRefactor extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ClientesRefactor dialog = new ClientesRefactor();
	...
	public ClientesRefactor() {
		setTitle("Clientes");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientesRefactor.class.getResource("/img/UsersIcon2.png")));
		setResizable(false);
		...
		btnAdicionar.setIcon(new ImageIcon(ClientesRefactor.class.getResource("/img/cliAdd.png")));
		...
		btnEditar.setIcon(new ImageIcon(ClientesRefactor.class.getResource("/img/cliEdit.png")));
		...
		btnExcluir.setIcon(new ImageIcon(ClientesRefactor.class.getResource("/img/cliRemove.png")));
		...
		btnExcluir_1.setIcon(new ImageIcon(ClientesRefactor.class.getResource("/img/erase.png")));
