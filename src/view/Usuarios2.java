...
public class Usuarios2 extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Usuarios2 dialog = new Usuarios2();
	...
	public Usuarios2() {
		...
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Usuarios2.class.getResource("/img/UserIcon.png")));
		setTitle("Usuarios");
		setModal(true);
...
//					}
		...
		bttnBuscar.setIcon(new ImageIcon(Usuarios2.class.getResource("/img/search.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(Usuarios2.class.getResource("/img/erase.png")));
...
//		txtSenha.setDocument(new Validador(20));
		...
		bttnAdd.setIcon(new ImageIcon(Usuarios2.class.getResource("/img/plusIcon.png")));
		...
		bttnEditar.setIcon(new ImageIcon(Usuarios2.class.getResource("/img/EditIcon.png")));
